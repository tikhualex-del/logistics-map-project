...
export default function GeneralSettingsPage() {
    ...
    async function loadSettings() {
        try {
            ...
            const normalizedDistanceUnit = DISTANCE_UNIT_OPTIONS.includes(loadedDistanceUnit)
                ? loadedDistanceUnit
                : "km";
    ...
    return (
        ...
        >
            ...
            >
                Здесь настраиваются базовые параметры компании. Для первого безопасного MVP
                пока используем только название компании и часовой пояс.
            </p>
            ...
            {loading ? (
                ...
                >
                    ...
                    >
                        Пока это только безопасное подключение формы к данным.
                        <br />
                        На следующем шаге добавим сохранение изменений.
                    </div>
                </div>
            )}
        </main>
